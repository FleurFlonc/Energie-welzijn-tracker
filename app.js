  ...
  <div class="container">
    ...
    <div id="viewLog">
      <div class="card">
        ...
        <div class="small-note" id="dateStatus" class="statuspill warn" style="margin-top:8px;">Nog open</div>
        <div class="small-note" style="margin-top:4px;">Groen = ingevuld • gestreept groen = ingevuld maar nog niet opgeslagen</div>
        </div>
      </div>
